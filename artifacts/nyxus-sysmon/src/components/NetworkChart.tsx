          ...
          <AreaChart data={history} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
            <defs>
              <linearGradient id="upGrad" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#ff8a1e" stopOpacity={0.8}/>
                <stop offset="95%" stopColor="#ff8a1e" stopOpacity={0.1}/>
              </linearGradient>
              <linearGradient id="downGrad" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#2bd2ff" stopOpacity={0.5}/>
                <stop offset="95%" stopColor="#2bd2ff" stopOpacity={0.1}/>
              </linearGradient>
            </defs>
