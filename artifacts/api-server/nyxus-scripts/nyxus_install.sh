...
for s in audio battery bluetooth brightness calendar cpu-bars mic network \
          ...
          updates weather workspaces quicksettings qs-toggle wifi-list \
          wifi-action bt-list bt-action audio-sinks audio-action \
          calendar-month notif-history notif-action; do
