...
for i in range(120):
    ...
    col = random.choice([(121, 73, 242, 16), (38, 255, 183, 12), (255, 38, 103, 10)])
    bd.ellipse((x - rr, y - rr // 2, x + rr, y + rr // 2), fill=col)
...
bd = ImageDraw.Draw(bh)
cx, cy = PW // 2, PH // 2
for rad, col, a in [(220, (255, 176, 38), 70), (170, (255, 120, 70), 55), (120, (255, 38, 103), 40)]:
...
neb = Image.new("RGBA", (W, H), (0, 0, 0, 0))
nd = ImageDraw.Draw(neb)
nd.ellipse((40, 120, 440, 480), fill=(255, 176, 38, 22))
nd.ellipse((200, 60, 520, 360), fill=(121, 73, 242, 20))
...
for x in range(0, DCW, 48):
    gd.line([(x, 0), (x, DCH)], fill=(38, 255, 183, 10), width=1)
for y in range(0, DCH, 48):
    gd.line([(0, y), (DCW, y)], fill=(121, 73, 242, 10), width=1)
img = Image.alpha_composite(img, grid)
neb = Image.new("RGBA", (DCW, DCH), (0, 0, 0, 0))
nd = ImageDraw.Draw(neb)
nd.ellipse((200, 120, 900, 580), fill=(38, 255, 183, 16))
nd.ellipse((500, 200, 1100, 620), fill=(255, 38, 103, 12))
...
for i in range(90):
    ...
    col = random.choice([(121, 73, 242, 14), (38, 255, 183, 10), (255, 38, 103, 8)])
    bd.ellipse((x - rr, y - rr // 2, x + rr, y + rr // 2), fill=col)
...
cx, cy = SW // 2, SH // 2
for rad, col, a in [(420, (121, 73, 242), 28), (320, (38, 255, 183), 22), (220, (255, 38, 103), 18)]:
