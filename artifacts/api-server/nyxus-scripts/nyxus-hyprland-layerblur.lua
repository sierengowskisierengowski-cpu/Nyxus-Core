...
-- ── P2.11 · slide-in animation for the Notification Center.
--    Hyprland animates layer-shell namespaces by name; tagging the
--    notification + quick-settings panels with `animation slide` gives
--    them a Mac/Windows-grade slide-from-edge entrance/exit for free,
--    with no eww-side timing scripts.
layerrule = animation slide, nyxus-notifications
